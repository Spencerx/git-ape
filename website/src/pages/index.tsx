...
const useCases = [
  ...
  { title: 'Deploy', desc: 'OIDC-based GitHub Actions deploy on PR merge. No stored secrets, full audit trail.', icon: 'fas fa-rocket', gradient: 'linear-gradient(135deg, #3498db, #2980b9)', link: '/docs/use-cases/cicd-pipeline' },
