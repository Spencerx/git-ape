---
title: "Azure Stack Destroy"
sidebar_label: "Azure Stack Destroy"
...
<!-- AUTO-GENERATED — DO NOT EDIT. Source: .github/skills/azure-stack-destroy/SKILL.md -->
...
| Property | Value |
|----------|-------|
| **Skill Directory** | `.github/skills/azure-stack-destroy/` |
| **Phase** | General |
| **User Invocable** | ✅ Yes |
| **Usage** | `/azure-stack-destroy Deployment ID — add --yes to skip the typed confirmation` |
