---
title: "Git-Ape: Workshop Deck Build"
sidebar_label: "Workshop Deck Build"
description: "GitHub Actions workflow: Git-Ape: Workshop Deck Build"
---

<!-- AUTO-GENERATED — DO NOT EDIT. Source: .github/workflows/git-ape-deck-build.yml -->
...
- **`push`** — branches: `["main"]` — paths: `workshops/track-*/*_deck.md, workshops/shared/img/**, .github/agents/**...`
- **`workflow_dispatch`**
      ...
      - name: Detect rendered file changes
        ...
        run: |
          ...
          if [[ -z "$CHANGED_OUTPUTS" ]]; then
            ...
            echo "ℹ️ No rendered file changes; nothing to commit."
          else
            echo "changed=true" >> "$GITHUB_OUTPUT"
            echo "✅ Rendered files differ from main; will open auto-PR."
      ...
      - name: Find open workshop-sync Issue
        ...
        run: |
          ...
          if [[ -n "$NUM" && "$NUM" != "null" ]]; then
            ...
            echo "ℹ️ Will reference workshop-sync Issue #$NUM (auto-close on merge)."
          else
            echo "number=" >> "$GITHUB_OUTPUT"
            echo "ℹ️ No open workshop-sync Issue."
          fi
      ...
      - name: Push to auto branch and open/update PR
        ...
        run: |
          ...
          ARTIFACT_URL="https://github.com/${REPO}/actions/runs/${RUN_ID}"
          {
            ...
            echo ""
            echo "The **complete screenshot set** (every slide × PDF and PPTX) is attached as workflow artifact \`workshop-deck-screenshots-${RUN_ID}\`. [Download from the workflow run]($ARTIFACT_URL)."
            echo ""
