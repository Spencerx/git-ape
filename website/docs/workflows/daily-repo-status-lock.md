---
title: "Daily Repo Status"
sidebar_label: "Daily Repo Status"
description: "GitHub Actions workflow: Daily Repo Status"
---

<!-- AUTO-GENERATED — DO NOT EDIT. Source: .github/workflows/daily-repo-status.lock.yml -->


# Daily Repo Status

**Workflow file:** `.github/workflows/daily-repo-status.lock.yml`
...
```yaml
# gh-aw-metadata: {"schema_version":"v3","frontmatter_hash":"894339bb13dd70330e962756b5d6c9f0b1e2a45fa72eb57fed9eda15479a0af4","compiler_version":"v0.72.1","strict":true,"agent_id":"copilot"}
...
#
# To update this file, edit githubnext/agentics/workflows/daily-repo-status.md@fc4ab36dedc44e2a1cdc195cecce262f06c81230 and run:
#   gh aw compile
    ...
    steps:
      - name: Setup Scripts
        ...
        with:
          ...
          job-name: ${{ github.job }}
        env:
          GH_AW_SETUP_WORKFLOW_NAME: "Daily Repo Status"
    ...
    steps:
      ...
      - name: Process no-op messages
        ...
        env:
          ...
          GH_AW_WORKFLOW_SOURCE: "githubnext/agentics/workflows/daily-repo-status.md@fc4ab36dedc44e2a1cdc195cecce262f06c81230"
          GH_AW_WORKFLOW_SOURCE_URL: "${{ github.server_url }}/githubnext/agentics/blob/fc4ab36dedc44e2a1cdc195cecce262f06c81230/workflows/daily-repo-status.md"
    ...
    steps:
      ...
      - name: Process Safe Outputs
        ...
        env:
          ...
          GITHUB_SERVER_URL: ${{ github.server_url }}
          GITHUB_API_URL: ${{ github.api_url }}
          GH_AW_SAFE_OUTPUTS_HANDLER_CONFIG: "{\"create_issue\":{\"close_older_issues\":true,\"labels\":[\"report\",\"daily-status\"],\"max\":1,\"title_prefix\":\"[repo-status] \"},\"create_report_incomplete_issue\":{},\"missing_data\":{},\"missing_tool\":{},\"noop\":{\"max\":1,\"report-as-issue\":\"true\"},\"report_incomplete\":{}}"
        with:
          github-token: ${{ secrets.GH_AW_GITHUB_TOKEN || secrets.GITHUB_TOKEN }}
          script: |
            const { setupGlobals } = require('${{ runner.temp }}/gh-aw/actions/setup_globals.cjs');
